  ...
  <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm ">
    <form action="#" method="POST" className="space-y-6">
      <div>
        ...
        <div className="mt-2">
          <input id="email" type="email" name="email" required placeholder="email" className="block w-full rounded-md bg-white dark:bg-[#1C2433] px-3 py-1.5 text-base text-white outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
        </div>
      </div>
      ...
      <div>
        ...
        <div className="mt-2">
          <input id="password" type="password" name="password" required placeholder="current-password" className="block w-full rounded-md bg-white dark:bg-[#1C2433] px-3 py-1.5 text-base text-white outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
        </div>
      </div>
